...
use App\Mail\DescontoAutorizado as AppDescontoAutorizado;
...
class candidatoController extends Controller
{
    ...
    public function descontoAutorizado($id, $mat, Request $request)
    {
        ...
        Mail::to($candidato->respfin->email_fin)->send(new AppDescontoAutorizado($candidato));
        return redirect()->back();
    }
    public function descontoIndeferido($id, $mat)
    {
        candidato::where('id_cand', $mat)
            ->update(['desc_aut' => null, 'status_id' => '4', 'status_desc' => 'Indeferido']);
        return redirect()->back();
    }
